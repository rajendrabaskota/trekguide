...
export const TrekDescription = () => {
  ...
  useEffect(() => {
    ...
    //   const data = await fetch("http://127.0.0.1:8000/api/route-info/?dest_id="+dest_id);
    //   const json = await data.json()
    //   setRoute_info(json)
    ...
    //   const data = fetch("http://127.0.0.1:8000/api/city-info/?dest_id="+dest_id);
    //   const json = await data.json()
    //   setCity_info(json)
  ...
  // let searched_desc = desc.destination.dest_name.toLocaleLowerCase();
